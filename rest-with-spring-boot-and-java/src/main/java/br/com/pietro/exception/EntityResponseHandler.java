...
public class EntityResponseHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(NotFoundRepositoryOperation.class)
    public final ResponseEntity<ExceptionResponse> handleNotFoundRepositoryException (Exception ex, WebRequest request){
        ExceptionResponse response = new ExceptionResponse(
                new Date(),
                ex.getMessage(),
                request.getDescription(false));
